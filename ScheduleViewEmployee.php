...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <div class="form-group" style="width:20%; margin-left:550px;">
...
<!---End Dropdown to select the week for the schedule --->
  <button style = "float:right; margin-right:650px; margin-top:-50px; " type="submit" class="btn btn-outline-info">Update</button>
</form>
